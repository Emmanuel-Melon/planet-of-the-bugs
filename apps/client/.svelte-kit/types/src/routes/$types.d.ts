...
type LayoutRouteId = RouteId | "/" | "/about" | "/about/[slug=slug]" | "/auth" | "/auth/new-user" | "/authored" | "/authored/edit" | "/chat" | "/courses" | "/courses/[slug]" | "/courses/[slug]/[lesson]" | "/explore" | "/issues" | "/notifications" | "/profile" | "/settings" | null
type LayoutParams = RouteParams & { slug?: string,lesson?: string }
