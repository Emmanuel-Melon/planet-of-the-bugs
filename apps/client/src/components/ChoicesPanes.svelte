...
<header class="flex mx-auto items-center justify-center p-4">
    <ul class="steps text-primary">
        ...
        <li class="step step-success" data-content="🤑">Get paid to squash bugs</li>
      </ul>
</header>
<main>
    <section class="flex mx-auto items-center justify-center p-4 bg-accent gap-4 w-fit">
        <div class="card w-96 h-80 bg-white shadow-xl border-solid border-neutral border-y">
            <div class="card-body">
